...
<div style="background-color: black;color:white; " class="container">
	<div style="font-weight: bolder" class="d-flex p-2 text-dark">
		<div class="p-2 bg-white"><a href="admindash.php"><i class='fa fa-home text-warning'></i> HOME</a></div>
...
<!--home image -->
<div style="opacity:0.8;background-repeat:no-repeat;background-image: url('images/bg4.jpg');width:100% 100%;height:700px;background-size: 100%">
	<br><br>
	<h1 style="text-align:center;color:white;font-family: verdana;font-weight: bolder">Admin Dashbooard</h1>
	<h4 style="text-align:center;color:white">Administrator><span style="color:orange">Dashboard</span></h4>
	<h1 style="color:red;font-family: verdana;font-weight: bolder;">We are proud of you </h1>
	<br><br>
</div>
</body>
</html>